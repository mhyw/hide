		...
		try {
			...
			case 'owner':
				...
				case 'galaxtext':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/galaxytext?text=${teks}&apikey=mhywazumiii`)
				...
				case 'primbonjodoh':
					...
					var gbl1 = gh.split("|")[0];
					var gbl2 = gh.split("|")[1];
					anu = await fetchJson(`https://api.vhtear.com/primbonjodoh?nama=${gbl1}&pasangan=${gbl2}&apikey=mhywazumiii`)
				...
				case 'ramaljadian':
					...
					var gbl2 = gh.split("|")[1];
					var gbl3 = gh.split("|")[2];
					anu = await fetchJson(`https://api.vhtear.com/harijadian?tgl=${gbl1}&bln=${gbl2}&thn=${gbl3}&apikey=mhywazumiii`)
					reply(anu.result.hasil)
					break
                case 'tahta':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/hartatahta?text=${teks}&apikey=mhywazumiii`)
				...
				case 'lovemake':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${love}&apikey=mhywazumiii`)
				...
				case 'thunder':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/thundertext?text=${thun}&apikey=mhywazumiii`)
                ...
                case 'stiltext':
                      ...
                      gl1 = gh.split("|")[0];
                      gl2 = gh.split("|")[1];
                      buff = await getBuffer(`https://api.vhtear.com/silktext?text=${gl1}&text2=${gl2}&apikey=mhywazumiii`)
                      reply(mess.wait)
				...
				case 'testing2':
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(mess.wait)
					party = await getBuffer(`https://api.vhtear.com/partytext?text=${coli1}&text2=${coli2}&apikey=mhywazumiii`)
				...
				case 'party':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/partytext?text=${part}&apikey=mhywazumiii`)
				...
				case 'rtext':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/romancetext?text=${tels5}&apikey=mhywazumiii`)
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
				...
				case 'walpaperhd':
					...
					teks = body.slice(7)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/walpaper?query=${teks}&apikey=mhywazumiii`)
				...
				case 'wibu':
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomwibu&apikey=mhywazumiii`)
					if (anu.error) return reply(anu.error)
				...
				case 'randomcat':
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomcat?apikey=mhywazumiii`)
					if (anu.error) return reply(anu.error)
				...
				case 'mlherolist':
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/mlherolist?apikey=mhywazumiii`)
				...
				case 'ramalhp':
					if (args.length < 1) return reply('teks nya mana om')
					kj = body.slice(12)
					anu = await fetchJson(`https://api.vhtear.com/nomerhoki?no=${kj}&apikey=mhywazumiii`)
					reply(anu.result.hasil)
					break
				case 'textscreen':
					if (args.length < 1) return reply('teks nya mana om')
					tels = body.slice(9)
					anu = await fetchJson(`https://api.vhtear.com/textscreen?query=${tels}&apikey=mhywazumiii`, {method: 'get'})
					reply(anu.result.text)
					break
			    case 'joox':
				if (args.length < 1) return reply('Nama lagunya apa kak?')
                    anu = await fetchJson(`https://api.vhtear.com/ytmp3?query=${body.slice(6)}&apikey=mhywazumiii`)
               ...
               case 'infogempa':
                ...
                case 'infocuaca':
                   ...
                   break
                case 'tebakgambar':
					anu = await fetchJson(`https://api.vhtear.com/tebakgambar&apikey=mhywazumiii`, {method: 'get'})
					...
					break
                case 'caklontong':
					anu = await fetchJson(`https://api.vhtear.com/funkuis&apikey=mhywazumiii`, {method: 'get'})
					setTimeout( () => {
					...
					break
				case 'family100':
					anu = await fetchJson(`https://api.vhtear.com/family100&apikey=mhywazumiii`, {method: 'get'})
					setTimeout( () => {
					client.sendMessage(from, '*➸ Jawaban :* '+anu.result.jawaban, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
                ...
                case 'brainly':
					...
					anu = await fetchJson(`https://api.vhtear.com/branly?query=${body.slice(9)}&apikey=mhywazumiii`, {method: 'get'})
					reply(anu.result.data)
					break
                case 'image':
					if (args.length < 1) return reply('Apa yang mau dicari kak?')
					goo = body.slice(7)
					anu = await fetchJson(`https://api.vhtear.com/googleimg?query=${goo}&apikey=mhywazumiii`, {method: 'get'})
					reply(mess.wait)
                ...
                case 'pokemon':
					...
					break
				case 'inu':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=inu&apikey=mhywazumiii`, {method: 'get'})
					...
					break
				case 'elang':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=elang&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'naruto':
					...
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=naruto&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'minato':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=minato&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'boruto':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=boruto&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'hinata':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hinata&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'sasuke':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sasuke&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'sakura':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sakura&apikey=mhywazumiii`, {method: 'get'})
					...
					//animefoto
				case 'unta':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=unta&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'kaneki':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kaneki&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'toukachan':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ToukaKirishima&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'rize':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=RizeKamishiro&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'akira':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=akiramado&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'itori':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=itori&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'kurumi':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kurumi&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'miku':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=Nakanomiku&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'hentai':
					...
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=animehentai&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'loli2':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=loli&apikey=mhywazumiii`, {method: 'get'})
                ...
                case 'pinterest':
					...
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pin}&apikey=mhywazumiii`, {method: 'get'})
					reply(mess.wait)
				...
				case 'tulis':
					...
					tulis = body.slice(6)
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/write?text=${tulis}&apikey=mhywazumiii`)
			    ...
			    case 'lovemake':
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buff = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${teks}&apikey=mhywazumiii`, {method: 'get'})
                    client.sendMessage(from, buff, image, {quoted: mek, caption: `${teks}`})
			     	break
			    case 'shorturl':
			    ...
			    case 'igstalk':
					...
					ige = body.slice(9)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/igprofile?query=${ige}&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'infomobil':
					...
					ige = body.slice(9)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomobil?merk=${ige}&apikey=mhywazumiii`, {method: 'get'})
				...
				case 'infomotor':
					...
					ft1 = body.slice(11)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomotor?merk=${ft1}&apikey=mhywazumiii`)
					buffer = await getBuffer(anu.result.image)
				...
				case 'playstore':
					kuji = body.slice(7)
					reply(mess.wait)
					anu = await getBuffer(`https://api.vhtear.com/playstore?query={kuji}&apikey=mhywazumiii`)
